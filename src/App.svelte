...
<div class="container mx-auto h-screen select-none">
	<aside class=" fixed right-0 h-full w-12">
		<svg
			...
			aria-hidden="true"
			class="hover:cursor-pointer hover:fill-gray-300 hover:rotate-12 transition-all fill-white active:scale-95"
		>
			<path
